...
class Author
{
    ...
    public function getAfiliation(): string { return $this->afiliation; }
    ...
    public function setPassword(string $password): void { $this->password = password_hash($plain, PASSWORD_BCRYPT); }
    public function setOrcid(string $orcid): void { $this->orcid = $orcid; }
    public function setAfiliation(string $afiliation): void { $this->afiliation = $afiliation; }
